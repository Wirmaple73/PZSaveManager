namespace SavepointManager.Classes
{
	public static class MessageBoxManager
	{
		...
		public static DialogResult ShowPrompt(string text, string title, MessageBoxIcon icon = MessageBoxIcon.Warning, bool isYesDefault = false)
			=> Show(text, title, icon, MessageBoxButtons.YesNo, isYesDefault ? MessageBoxDefaultButton.Button1 : MessageBoxDefaultButton.Button2);
	}
}
