	...
	public class Save
	{
		...
		private static XDocument CreateMetadata(string worldName, string worldGamemode, string description, DateTime date)
		{
			return new XDocument(
				new XComment($" Generated by Project Zomboid Save Manager {VersionManager.VersionText} "),
				new XElement(XmlElementName.SaveMetadata,
					new XAttribute(XmlElementName.Version, VersionManager.XmlMetadataVersionText),
